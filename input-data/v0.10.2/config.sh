...
DEPRECATED_SPATIAL_CELL_SUMMARIES=input-data/${VERSION}/sc-proteomics-cell-summaries.jsonld
DEPRECATED_SPATIAL_CELL_SUMMARY_DATASETS=input-data/${VERSION}/sc-proteomics-dataset-metadata.csv
