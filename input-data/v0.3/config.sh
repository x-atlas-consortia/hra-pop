...
DEPRECATED_BULK_CELL_SUMMARY_DATASETS=input-data/${VERSION}/bulk-cell-summaries.csv
DEPRECATED_SPATIAL_CELL_SUMMARY_DATASETS=input-data/${VERSION}/spatial-cell-summaries.csv

REGISTRATIONS="${DEPRECATED_REGISTRATIONS} \
  https://apps.humanatlas.io/hra-api/v1/hubmap/rui_locations.jsonld?token=${HUBMAP_TOKEN}&cache=true \
